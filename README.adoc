...
http://getreu.net/public/downloads/doc/asciiart-hangman-for-kids.rs/[getreu.net].
There you also find a
http://getreu.net/public/downloads/doc/asciiart-hangman-for-kids.rs/ASCII%20Art%20Hangman%20for%20Kids.pdf[
pdf rendition] of this document and compiled 
http://getreu.net/public/downloads/doc/asciiart-hangman-for-kids.rs/bin/[binaries].
