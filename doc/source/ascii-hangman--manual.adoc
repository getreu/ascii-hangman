...
does not find a line starting with the word `secrets` or `image:`, it falls
...
NOTE: Please update your configuration files to the new YAML format, as the
backward-compatibility mode will be dropped in the future to simplify
maintenance.
