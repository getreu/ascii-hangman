...
`.zip` file, unpack, find `hangman` binary, grant execution rights, open
...
----
include::../../src/main.rs[lines="100..145"]
----
...
hereafter referred to as secret words of guessing words.
