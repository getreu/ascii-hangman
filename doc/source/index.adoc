...
. Edit the configuration file
+
Double-click on `hangman-words.txt`. This opens the file in the `Notepad` 
...
include::../../src/main.rs[lines="60..121"]
...
*  When the game starts the computer will choose one secret of the list
   ...
   Every secret appears only once, unless it is not guessed 
   correctly. Then it will be presented again.
