...
* Binaries and packages (usually built from latest commit):
  ...
  - Package for Debian and Ubuntu:
    ...
    [x86_64-unknown-linux-gnu/debian/ascii-hangman_5.6.0_amd64.deb](https://blog.getreu.net/projects/ascii-hangman/_downloads/x86_64-unknown-linux-gnu/debian/ascii-hangman_5.6.0_amd64.deb)
