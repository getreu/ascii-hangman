...
* Binaries and packages (usually built from latest commit):
  ...
  - Package for Debian and Ubuntu:
    ...
    [x86_64-unknown-linux-gnu/debian/ascii-hangman_1.3.2_amd64.deb](https://blog.getreu.net/projects/ascii-hangman/_downloads/x86_64-unknown-linux-gnu/debian/ascii-hangman_4.9.1_amd64.deb)
